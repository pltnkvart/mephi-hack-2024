...
const data: YagrWidgetData = {
    ...
    libraryConfig: {
        ...
        title: {
            text: 'Team Engagement (Вовлеченность команды)',
        },
    },
};
...
export const TeamEngagementChart = () => {
    return (
        <div className={styles.chart}>
            ...
            <Text variant="body-1" color="secondary" wordBreak="break-all">
                Формула: (Количество комментариев и обсуждений по пул-реквестам + Участие в тренингах + Количество проведенных юнит-тестов) / Общее количество сотрудников
            </Text>
        </div>
    );
}
